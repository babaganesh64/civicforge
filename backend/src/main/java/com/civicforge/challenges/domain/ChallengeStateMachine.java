...
public class ChallengeStateMachine {
    ...
    private static final List<Transition> TRANSITIONS = List.of(
        ...
        new Transition(SUBMITTED, ROUTE, ROUTED),
        new Transition(UNDER_REVIEW, ROUTE, ROUTED),
        new Transition(VERIFIED, ROUTE, ROUTED),
        new Transition(CLASSIFIED, ROUTE, ROUTED),
        new Transition(PUBLISHED, ROUTE, ROUTED),
